...
//Controla el cambio en el select de region
  $('#cvgeo').on('change', function(){
    ...
    $.ajax({
        ...
        url: "http://localhost/Sistema_Web_HojasDeDatos_DIGEPO_INEGI/public/graficaEducacionMunicipal/",
        ...
        success: function (response) {
            ...
            const graficaEducacion = document.getElementById('graficaEducacionMunicipal');
