...
//Controla el cambio en el select de region
  $('#cvgeo').on('change', function(){
    ...
    $.ajax({
        ...
        url: "http://localhost/Sistema_Web_HojasDeDatos_DIGEPO_INEGI/public/graficaViviendaMunicipal/",
        ...
        success: function (response) {
            ...
            const graficaVivienda = document.getElementById('graficaViviendaMunicipal');
