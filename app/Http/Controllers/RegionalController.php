...
class RegionalController extends Controller
{
  ...
  public function graficaSalud(Request $request){
    $region = $request->region;
    ...
    $graficasalud =Llave::join("Salud", "Salud.cve_geo", "=", "Llave.cvgeo")
       ->select(Llave::raw("SUM (Salud.imss) as total_imss"),
        ...
        Llave::raw("SUM (Salud.no_afiliada) as total_no_afiliada"))->where("Llave.region","=",$region)->get();
  ...
  public function graficaTrabajo(Request $request){
    $region = $request->region;

    $graficaTrabajo = Llave::join("Trabajo", "Trabajo.cve_geo", "=", "Llave.cvgeo")->select(Llave::raw("SUM (Trabajo.total_eco_activa) as total_eco_activa"), Llave::raw("SUM (Trabajo.no_economicamente_activa) as total_no_eco_activa"))->where("Llave.region","=",$region)->get();
